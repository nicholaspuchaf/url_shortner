...
export const stringsEn = {
  ...
  shortenerCard: {
    ...
    qrPreviewAlt: 'QR Code generated for the short URL',
    qrFallbackTitle: 'QR Code generated without shortening',
    qrFallbackHint: 'The API did not respond, so the QR Code points to the original URL.',
    ...
    resultOriginalUrlLabel: 'Original URL',
